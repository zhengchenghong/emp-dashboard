...
export default {
  success: {
    create: {
      message: en['New school has been created Successfully!'],
      options: {
    ...
    delete: {
      message: en['The school has been removed Successfully!'],
      options: {
        autoHideDuration: 10000,
        variant: 'success'
      }
    ...
    update: {
      message: en['The school has been updated Successfully!'],
      options: {
        autoHideDuration: 10000,
        variant: 'success'
      }
    ...
    import: {
      message: en['A request has been sent to import Canvas Class.'],
      options: {
        autoHideDuration: 10000,
        variant: 'success'
      }
